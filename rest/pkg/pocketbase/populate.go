...
var (
	exhibits = []utils.Exhibit{
		...
		},
		{
			...
			Description: "American Gothic is an oil painting on panel by the American artist Grant Wood, completed in 1930. It is now in the Art Institute of Chicago. The painting depicts a farmer and his daughter standing in front of a rural American house with a Gothic Revival-style architecture. The painting is a classic example of American Gothic art, and has been widely parodied and referenced in popular culture. It is one of the most recognizable paintings in the world.",
			ClusterID:   "4",
			Img:         "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9d/Grant_Wood_-_American_Gothic_-_Google_Art_Project.jpg/1200px-Grant_Wood_-_American_Gothic_-_Google_Art_Project.jpg",
		},
		{
			Name:        "Autoportrait",
			Description: "Autoportrait is a 1940 painting by Pablo Picasso. It is a self-portrait of the artist, painted in the style of a Cubist portrait. It is currently in the Musée national Picasso-Paris.",
			ClusterID:   "1",
			Img:         "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Picasso%2C_Pablo_-_Autoportrait%2C_1940_-_Google_Art_Project.jpg/1200px-Picasso%2C_Pablo_-_Autoportrait%2C_1940_-_Google_Art_Project.jpg",
		},
		{
			Name:        "Death of Marat",
			Description: "The Death of Marat is an oil painting by Jacques-Louis David, completed in 1793. It depicts the assassination of French revolutionary leader Jean-Paul Marat as carried out by Charlotte Corday. The painting is now in the Musée du Louvre in Paris.",
			ClusterID:   "5",
			Img:         "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Jacques-Louis_David_-_Death_of_Marat_-_Google_Art_Project.jpg/1200px-Jacques-Louis_David_-_Death_of_Marat_-_Google_Art_Project.jpg",
		},
	}
)
