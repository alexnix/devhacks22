;(function( $, window, document, undefined ) {
  ...
  QRCodeReader.prototype = {
    ...
    buildHTML: function() {
      ...
      qrr.container = $('<div id="qrr-container" class="popup"></div>');
    ...
    read: function() {
      ...
      if (qrr.video.readyState === qrr.video.HAVE_ENOUGH_DATA) {
        ...
        qrr.canvas[0].height = window.innerHeight; //qrr.video.videoHeight;
        qrr.canvas[0].width = window.innerWidth; //qrr.video.videoWidth;
